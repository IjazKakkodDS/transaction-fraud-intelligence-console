...
| Final narrated demo artifact | 10M scan demo flow | Local generated media | Playwright recording, captions, Edge TTS, FFmpeg merge | Documented | 2m 28.8s narrated MP4 artifact generated locally; media output remains ignored and is not committed | Product screenshots and benchmark evidence are retained in the public docs; internal demo-generation materials are not part of the public repository |
